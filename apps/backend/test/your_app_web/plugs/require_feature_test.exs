defmodule YourAppWeb.Plugs.RequireFeatureTest do
  use YourAppWeb.ConnCase, async: false

  alias YourAppWeb.Plugs.RequireFeature

  describe "call/2" do
    setup do
      original = Application.get_env(:your_app, :features)

      on_exit(fn ->
        if original do
          Application.put_env(:your_app, :features, original)
        else
    ...
    test "works generically for any feature flag" do
      Application.put_env(:your_app, :features, feature_x: true)
